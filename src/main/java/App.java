...
public class App {
    public static void main(String[] args) {
        ...
        //We'll need to call save() in this route to ensure all Category objects created through Spark are also present in our database:
        ...
        //We can create the route that will update the Task upon form submission now:
        ...
        // let's first create a route that specializes in deleting Tasks.
